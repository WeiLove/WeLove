...
#import "BMapKit.h"
#import "HRLMapService.h"
#import "HRLLocationService.h"
#import "MBProgressHUD.h"

@interface HRLMapViewController ()<BMKMapViewDelegate>
...
@implementation HRLMapViewController
...
-(void)dealloc
{
    ...
    [[HRLMapService shareInstance] stop];
}
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        [[HRLLocationService shareInstance] startUpdatingLocation];
        [[HRLMapService shareInstance] start];
        [[NSNotificationCenter defaultCenter] removeObserver:self
...
{
    if ([HRLLocationService isLocationEnabled])
    {
        CLLocation *location = [HRLLocationService shareInstance].location;
