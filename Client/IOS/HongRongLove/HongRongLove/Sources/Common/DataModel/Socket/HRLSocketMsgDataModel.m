...
@implementation HRLSocketSendMsgParam
...
{
    HRLSocketSendMsgParam *dataModel = [[HRLSocketSendMsgParam alloc] init];
...
@implementation HRLSocketQueryUnReadMsgParam

+ (instancetype)queryUnReadMsgParam:(NSString *)from_uid
{
    HRLSocketQueryUnReadMsgParam *dataModel = [[HRLSocketQueryUnReadMsgParam alloc] init];
...
@implementation HRLSocketMsgDataModel
