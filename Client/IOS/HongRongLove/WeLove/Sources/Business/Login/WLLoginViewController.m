...
- (void)viewDidLoad
{
    ...
    //读取保存的账号信息
    NSString *userId = [[WLUserDefaultService shareInstance] valueForKey:kUserDefaultKey_Uid];
    NSString *password= [[WLUserDefaultService shareInstance] valueForKey:kUserDefaultKey_Password];
...
- (void)loginBtnClicked:(id)sender
{
    ...
    __block WLUserDataModel *result = nil;
    ...
    [WLRPCService asyncRPCBlock:^{
        ...
        request.isPost = YES;
        request.parseCls = [WLUserDataModel class];
        ...
        if (result.success)
        {
            [[WLUserDefaultService shareInstance] storeValue:userId forKey:kUserDefaultKey_Uid];
            
            if (shouldRemindPassword)
            {
                [[WLUserDefaultService shareInstance] storeValue:password forKey:kUserDefaultKey_Password];
            }
        ...
        {
            //clear password
            [[WLUserDefaultService shareInstance] storeValue:@"" forKey:kUserDefaultKey_Password];
