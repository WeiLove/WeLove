...
static WLLocationService *instance = nil;

@interface WLLocationService()<CLLocationManagerDelegate>
...
@implementation WLLocationService
...
+ (instancetype)shareInstance
{
    ...
    dispatch_once(&onceToken, ^{
        if (!instance)
        {
            instance = [[WLLocationService alloc] init];
        }
    });
